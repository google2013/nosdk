...
public class UCGameSdk {
     ...
     */
    public static void initSDK(final Activity activity, final boolean debugMode, int gameId, boolean enablePayHistory, boolean enableUserChange, int orientation) {
        ...
        currentActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().initSdk(currentActivity, sdkParams);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void login() {
        currentActivity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().login(currentActivity, null);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void logout() {
        currentActivity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().logout(currentActivity, null);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void submitRoleData(String zoneId, final String zoneName, final String roleId, final String roleName, long roleLevel, long roleCTime) {
        ...
        currentActivity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().submitRoleData(currentActivity, sdkParams);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void pay(String accountId, String cpOrderID, String amount, String callbackInfo, String notifyUrl, String signType, String sign) {
        ...
        currentActivity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().pay(currentActivity, sdkParams);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void exitSDK() {
        currentActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().exit(currentActivity, null);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
    ...
    public static void showPage(String action, String business, int orientation) {
        ...
        currentActivity.runOnUiThread(new Runnable() {
            public void run() {
                try {
                    cn.uc.gamesdk.UCGameSdk.defaultSdk().execute(currentActivity, sdkParams);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
