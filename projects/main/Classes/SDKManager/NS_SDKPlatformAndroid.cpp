...
void NS_SDKPlatform::callStringFunc( char* json )
{
    
}

void NS_SDKPlatform::callVoidFunc( char* json )
{
    
}

void NS_SDKPlatform::callBoolFunc( char* json )
{
    
}

void NS_SDKPlatform::callIntFunc( char* json )
{
